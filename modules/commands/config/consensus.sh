...
__query_consensus_only_client() {
  # When called with --test, just print to stdout for testing
  if [ "${1:-}" = "--test" ]; then
    echo "TODO: Implement full __query_consensus_only_client function with whiptail UI"
  ...
  # When sourced, this will run the actual function
  echo "TODO: Implement full __query_consensus_only_client function with whiptail UI" >&2
