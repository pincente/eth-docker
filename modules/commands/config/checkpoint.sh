...
__query_checkpoint_beacon() {
  ...
  if [ "${1:-}" = "--test" ]; then
    echo "TODO: Implement full __query_checkpoint_beacon function with whiptail UI"
  ...
  echo "TODO: Implement full __query_checkpoint_beacon function with whiptail UI" >&2
