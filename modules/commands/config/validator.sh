...
__query_validator_client() {
  ...
  if [ "${1:-}" = "--test" ]; then
    echo "TODO: Implement full __query_validator_client function with whiptail UI"
  ...
  echo "TODO: Implement full __query_validator_client function with whiptail UI" >&2
