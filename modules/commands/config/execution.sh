...
__query_execution_client() {
  ...
  if [ "${1:-}" = "--test" ]; then
    echo "TODO: Implement full __query_execution_client function with whiptail UI"
  ...
  echo "TODO: Implement full __query_execution_client function with whiptail UI" >&2
...
__query_custom_execution_client() {
  # When called with --test, just print to stdout for testing
  if [ "${1:-}" = "--test" ]; then
    echo "TODO: Implement full __query_custom_execution_client function with whiptail UI"
    echo "For now, skipping custom execution client for testing"
    return 0
  fi
  
  # When sourced, this will run the actual function
  echo "TODO: Implement full __query_custom_execution_client function with whiptail UI" >&2
